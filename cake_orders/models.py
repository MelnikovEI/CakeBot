...
class Order(models.Model):
    ...
    creation_datetime = models.CharField('date and time of the creation', max_length=100, blank=True)
    # models.DateTimeField("date and time of the creation")
    delivery_datetime = models.CharField('date and time of the delivery', max_length=100, blank=True)
    # models.DateTimeField("date and time of the delivery")
